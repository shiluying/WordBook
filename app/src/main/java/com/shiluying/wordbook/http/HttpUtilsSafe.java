package com.shiluying.wordbook.http;
...
public class HttpUtilsSafe {
   ...
   public interface  OnRequestCallBack{
    ...
    public void get(final Context context,final String cer, final String path, final OnRequestCallBack callBack){
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    instance.load(null);
                    instance.setCertificateEntry(cer,getX509Certificate(context,cer));
   ...
   //拿到自己的证书
   X509Certificate getX509Certificate(Context context,String cer) throws IOException, CertificateException {
       InputStream in = context.getAssets().open(cer+".cer");
