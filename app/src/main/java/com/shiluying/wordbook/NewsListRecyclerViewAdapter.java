...
import com.shiluying.wordbook.NewsListFragment.OnListFragmentInteractionListener;
...
public class NewsListRecyclerViewAdapter extends RecyclerView.Adapter<NewsListRecyclerViewAdapter.ViewHolder> {
    ...
    public NewsListRecyclerViewAdapter(List<NewsContent.NewsItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
